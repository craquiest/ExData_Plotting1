...
# Multi-Line graph of Sub-meterings
...
plot(plot_set_3$datetime  ,plot_set_3$Sub_metering_1,
     type = "l", xlab = "", ylab = "Energy sub metering")
#Add other lines
lines(plot_set_3$datetime , plot_set_3$Sub_metering_2,col="red")
lines(plot_set_3$datetime , plot_set_3$Sub_metering_3,col="blue")
